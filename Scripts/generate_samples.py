...
out_path = r'H:\Datasets\Objects\StreamflowSimulation\Data\LSTM\Samples\model_train_test_{}day.h5'.format(Config.pred_len_day)
...
generate_samples(df, Config.feature_names, Config.target_name, out_path, time_col_name='date', st_col_name='站名',
                 window_size=Config.seq_len_day)
print('_' * 50)
